...
function mergeCookies(clientCookies,backendCookies, backendName, logger){
  ...
  if (decryptedClientCookies[0]) {
    decryptedClientCookies.forEach(function (clientCookie) {
      let equalIndex = clientCookie.indexOf('=');
      let clientCookieKey = equalIndex > -1 ? clientCookie.substr(0, equalIndex) : null;
      let clientCookieValue = equalIndex > -1 ? clientCookie.substr(equalIndex + 1) : null;
